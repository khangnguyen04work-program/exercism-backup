...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    percentage_calculated = ((voltage * current) / theoretical_max_power) * 100
    
    if percentage_calculated >= 80: # Unit: %
        band = 'green'
    elif percentage_calculated < 80 and percentage_calculated >= 60:
        band = 'orange'
    elif percentage_calculated < 60 and percentage_calculated >= 30:
        band = 'red'
    else:
        band = 'black'
