...
def get_change(budget, exchanging_value):
    ...
    This function calculates and returns the amount of money left over from the budget after an exchange.
    """
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    total_raw_amount_new_currency = budget / (exchange_rate *(1+spread/100))
    number_of_whole_bills = total_raw_amount_new_currency // denomination
    maximum_value_new_currency = number_of_whole_bills * denomination
